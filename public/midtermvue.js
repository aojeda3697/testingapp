...
var fetchmeetings = function () {
  return fetch('https://glacial-coast-88563.herokuapp.com/meetings').then(function (response) {
...
var fetchclients = function () {
  return fetch('https://glacial-coast-88563.herokuapp.com/clients').then(function (response) {
    return response.json();
...
var app = new Vue({
  ...
  methods: {
    ...
    remove: function(item){
      ...
      if (k == true) {
        fetch('https://glacial-coast-88563.herokuapp.com/clients/'+item._id, {
    ...
    updateclient: function(){
      ...
      fetch('https://glacial-coast-88563.herokuapp.com/clients/'+app.updateitem._id, {
        method: 'PUT',
        headers: {
      ...
      if (r == true){
        fetch('https://glacial-coast-88563.herokuapp.com/meetings/'+meeting._id, {
        method: 'DELETE', // or 'PUT
        headers: {
        },
        }).then(function(response) {
    ...
    submit: function (){
      ...
      { fetch('https://glacial-coast-88563.herokuapp.com/clients', {
      method: 'POST', // or 'PUT
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded'
      },
...
send: function (){
  ...
  fetch('https://glacial-coast-88563.herokuapp.com/meetings', {
  method: 'POST', // or 'PUT
  headers: {
    'Content-Type': 'application/x-www-form-urlencoded'
  },
